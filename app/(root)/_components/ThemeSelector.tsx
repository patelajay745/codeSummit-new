...
const THEME_ICONS: Record<string, React.ReactNode> = {
  ...
  dracula: <Palette className="size-4" />,
  monokai: <Terminal className="size-4" />,
  "solarized-dark": <Sunset className="size-4" />,
  "solarized-light": <Sunrise className="size-4" />,
  "gruvbox-dark": <Zap className="size-4" />,
